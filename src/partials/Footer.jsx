    ...
    return (
            ...
            <div className="card-body">
                ...
                <div className="links-helps">
                    ...
                    <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        </svg> Email: contato@tosweeten.com
                    </p>
                </div>
            </div>
            <hr />
        ...
        <div className="logo-footer">
            <div className="text-center">
                <a className="logo" href="#">ToSweeten</a>
                <p>
                    <a className="assinatura" href="#"> @ 2022-2023, Grupo ToSweeten.</a>
                </p>
            </div>

            <p>
                <a className="assinatura" href="https://github.com/vitaolv"> Desenvolvido por Victor Veleda</a>
                <br /><span id="subassinatura">Feito com 🖤</span>
            </p>   
        </div>
        <br /> 
    </footer>
